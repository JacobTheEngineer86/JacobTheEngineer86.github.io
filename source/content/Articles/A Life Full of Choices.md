...
When confronted with a difficult choice, it can be tempting to *not* make a choice - but that in itself *is* a choice. Life never stands still. 

Life is full of choices - and we must avoid the temptation to let those choices slip by. 

When confronted with a difficult choice, many people may freeze, not wanting to commit to one path for fear of missing out on the benefits of the other path. 
...
Life is full of choices - and we can never make the same choice twice. Yes, we can and should learn from the past, but it’s impossible to go back in time and change a previously made decision. Life is always moving forward - absolutely nothing can stop that. 

That’s terrifying and exhilarating. 

Terrifying because our actions are set in stone. I can never take back a harsh word, never redo a bad day, never 

But I can always apologize, always do better the next day, always 


What are the choices we can never take back? The ones that are time based. Action oriented.

More important than individual choices is *who we become.* 


“Every action we take is a vote for the type of person we wish to become.” - James Clear

Say I made a choice to watch TV instead of going for a run. 
